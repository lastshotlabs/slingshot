...
- [Routes and Handlers](/app-authoring/routes-and-handlers/) — how route discovery works
- [OpenAPI](/guides/openapi/) — generated spec details
- [App Config](/app-authoring/app-config/) — full config surface
