...
- [Request IDs](/app-authoring/request-ids/) — every audit entry carries the request ID
- [Structured Logging](/app-authoring/logging/) — operational logs vs durable audit logs
- [Multi-Tenancy](/guides/multi-tenancy/) — `requestTenantId` makes per-tenant audit views easy
