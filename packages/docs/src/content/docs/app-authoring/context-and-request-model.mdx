...
- [createServer and createApp](/app-authoring/create-server-and-create-app/) — the assembly step
- [Middleware](/app-authoring/middleware/) — where request-scoped state intersects middleware chains
