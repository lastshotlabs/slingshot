...
- [Context and Request Model](/app-authoring/context-and-request-model/) — the deeper architecture
- [Middleware](/app-authoring/middleware/) — where request-scoped state intersects middleware
- [SlingshotContext reference](/authoring/context/) — full context API for plugin authors
