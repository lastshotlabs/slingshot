...
- [Encryption and Hashing](/app-authoring/encryption-and-hashing/) — the primitives behind `signCookieValue`
- [Authentication](/core-features/auth/) — how the framework cookies get set
