...
- [App Config](/app-authoring/app-config/) — all the config options
- [Context and Request Model](/app-authoring/context-and-request-model/) — app-scoped vs request-scoped state
- [Testing](/guides/testing/) — full testing guide with auth, entities, and SQLite
