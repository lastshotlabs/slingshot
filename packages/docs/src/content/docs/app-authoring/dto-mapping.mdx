...
- [Pagination](/app-authoring/pagination/) — combine projections with cursor pagination
- [Validation](/app-authoring/validation/) — request validation with the same Zod schemas
- [Data and Entities](/core-features/data-and-entities/) — the broader entity story
