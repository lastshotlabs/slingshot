...
- [Cookies](/app-authoring/cookies/) — `signCookieValue` is built on `hmacSign`
- [Request Signing & Webhook Auth](/app-authoring/request-signing/) — HMAC verification for inbound webhooks
- [Authentication](/core-features/auth/) — credential auth that uses the runtime password helpers
