...
1. **[Plugin Interface](/slingshot/authoring/plugin-interface/)** — when you need framework-level infrastructure (auth, persistence, queues) with lifecycle hooks.
2. **[Authoring Routes](/slingshot/authoring-routes/)** — per-route concerns once your package surfaces are settled.
