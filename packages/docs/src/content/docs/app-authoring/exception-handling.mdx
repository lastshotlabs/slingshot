...
in [Validation](/app-authoring/validation/).
...
- [Validation](/app-authoring/validation/) — input parsing and `400` responses
- [Routes and Handlers](/app-authoring/routes-and-handlers/) — the route DSL
- [Testing](/guides/testing/) — full test setup with `createApp`
