...
1. **[Authoring Routes](/slingshot/authoring-routes/)** — every concern that applies to a single route: validation, DTO mapping, idempotency, exception handling.
2. **[Working with Data](/slingshot/core-features/data-and-entities/)** — when a route should be generated from an entity model.
3. **[Security](/slingshot/core-features/auth/)** — auth and permissions.

Adjacent reference:

- [Package-First Authoring](/slingshot/package-first/) — feature module composition (revisit if you skipped here from Quick Start).
- [Entity System](/slingshot/entity-system/) — the full entity authoring story.
