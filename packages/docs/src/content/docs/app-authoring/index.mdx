...
If you have not built anything yet, start with the [Quick Start](/quick-start/).
...
See [App Config](/app-authoring/app-config/) for the full reference.
...
1. **[Authoring Routes](/authoring-routes/)** — every concern that applies to a single route: validation, DTO mapping, idempotency, exception handling.
2. **[Working with Data](/core-features/data-and-entities/)** — when a route should be generated from an entity model.
3. **[Security](/core-features/auth/)** — auth and permissions.

Adjacent reference:

- [Package-First Authoring](/package-first/) — feature module composition (revisit if you skipped here from Quick Start).
- [Entity System](/entity-system/) — the full entity authoring story.
- [Examples](/examples/) — complete apps to study.
