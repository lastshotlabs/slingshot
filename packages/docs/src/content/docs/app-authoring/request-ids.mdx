...
- [Structured Logging](/app-authoring/logging/) — the request log shape that includes the ID
- [Audit Logging](/app-authoring/audit-logging/) — every entry carries the request ID
- [Distributed Tracing](/app-authoring/distributed-tracing/) — correlate the ID with OTel spans
