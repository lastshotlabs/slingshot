...
[Data and Entities](/core-features/data-and-entities/).
...
[Domain and Route](/package-first/domain-and-route/) for the full reference.

## What's next

- [Middleware](/app-authoring/middleware/) — request-level interceptors
- [Context and Request Model](/app-authoring/context-and-request-model/) — `getContext`, actor, tenant
- [OpenAPI and Validation](/app-authoring/openapi-and-validation/) — schema-first specs
- [Domain and Route](/package-first/domain-and-route/) — the full route DSL reference
