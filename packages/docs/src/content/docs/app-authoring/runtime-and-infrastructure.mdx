...
- [Package-First Authoring](/package-first/) — the canonical composition surface
- [Entity System](/entity-system/) — data-shaped domains with generated routes and operations
- [Examples](/examples/) — complete apps that combine what you have learned
