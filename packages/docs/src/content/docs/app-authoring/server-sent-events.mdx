...
These examples extend the [starter app](/app-authoring/starter-app/) and the
`blog:post.published` event from
[Events and the Event Bus](/app-authoring/events-and-the-event-bus/).
...
Those belong to [WebSockets](/app-authoring/websockets/).
