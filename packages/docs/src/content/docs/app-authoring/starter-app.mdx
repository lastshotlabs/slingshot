...
- [Package-First Authoring](/package-first/) extends the `blogPackage`
- [Entity System](/entity-system/) extends the `Post` entity and its operations
- [Events and the Event Bus](/app-authoring/events-and-the-event-bus/) adds publication and subscriptions
- [Realtime](/core-features/realtime/) covers WebSockets and SSE delivery
