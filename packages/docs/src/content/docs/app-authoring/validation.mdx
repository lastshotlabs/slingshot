...
[Generated Routes, Overrides, and Extra Routes](/entity-system/generated-routes-overrides-and-extra-routes/).
...
- [Routes and Handlers](/app-authoring/routes-and-handlers/) — the route DSL surface
- [OpenAPI](/guides/openapi/) — customize the generated spec
- [Exception Handling](/app-authoring/exception-handling/) — non-validation errors
