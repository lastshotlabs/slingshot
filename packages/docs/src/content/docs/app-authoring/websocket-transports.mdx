...
- [WebSocket Presence](/app-authoring/websocket-presence/) — what cross-instance broadcast unlocks
- [WebSocket Recovery](/app-authoring/websocket-recovery/) — replay across reconnects
- [Horizontal Scaling](/guides/horizontal-scaling/) — full multi-instance deployment guide
