...
BullMQ is the built-in manifest option. Other brokers still work through the registry-backed custom event-bus path. See [Custom Event Bus](/examples/custom-event-bus/) for the full configuration.
