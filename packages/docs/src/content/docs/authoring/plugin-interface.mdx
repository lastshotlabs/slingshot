...
Capability resolvers must return a stable reference across every lifecycle phase. The
...
`packages/slingshot-orchestration-plugin/src/plugin.ts` for representative
implementations.
