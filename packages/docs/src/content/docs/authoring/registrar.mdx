...
- [SlingshotContext](/authoring/context/) — where the registrar snapshot lives at runtime
- [Plugin Interface](/authoring/plugin-interface/) — lifecycle phases where the registrar is populated
- [Internals: Context and Registrar](/internals/context-registrar/) — implementation details
