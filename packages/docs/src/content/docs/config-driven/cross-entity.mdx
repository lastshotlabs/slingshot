...
writes, or other external effects atomic. Framework-owned effects are delayed until commit where
supported, but durable atomic publication requires the transactional outbox planned in WP4.
