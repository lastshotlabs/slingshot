...
See [Secrets](/guides/secrets/) for the full reference.
...
- [Deployment Guide](/guides/deployment/) — step-by-step deploy walkthrough
- [Horizontal Scaling](/guides/horizontal-scaling/) — multi-instance configuration with shared state
- [Secrets](/guides/secrets/) — managing secrets across environments
- [slingshot-infra](/packages/slingshot-infra/) — full API reference for `definePlatform` and `defineInfra`
