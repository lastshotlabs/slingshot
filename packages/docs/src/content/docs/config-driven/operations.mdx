...
The captured adapter is then available inside any `custom` operation handler. See [The Manifest System — Hooks](/internals/manifest/#the-hooks-export) for details.
