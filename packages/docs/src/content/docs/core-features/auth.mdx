...
[HookServices](/app-authoring/hook-services/) for the full contract.
...
- **[Permissions](/core-features/permissions/)** — resource-level access control built on top of the actor model.

## Go deeper into auth

- [Auth Setup Example](/examples/with-auth/) — end-to-end auth walkthrough with OAuth, MFA, and passkeys
- [SaaS Foundations](/examples/saas-foundations/) — auth + organizations + permissions for multi-tenant
- [Maturity and Package Status](/core-features/maturity-and-package-status/) — current package stability expectations
