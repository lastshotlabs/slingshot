...
**[Permissions: Setup and Patterns](/guides/permissions/)**.
...
- **[Realtime](/core-features/realtime/)** — Server-Sent Events and WebSockets, with auth and permissions inherited from this layer.

## Go deeper into permissions

- [Permissions Guide](/guides/permissions/) — full setup, grants, and evaluation patterns
- [Route Policy](/entity-system/route-policy/) — per-route auth and permission configuration
- [Auth](/core-features/auth/) — identity and sessions (separate from permissions)
