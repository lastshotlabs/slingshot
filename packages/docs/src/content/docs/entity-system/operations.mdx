...
and configure the search adapter. See [Adding Search](/examples/adding-search/).
...
Operation availability and atomicity vary by store and are enforced at startup. Check the generated
[entity backend support matrix](/reference/entity-backend-support/) before selecting a persistence
backend.
...
- [Route Policy](/entity-system/route-policy/) — auth, permissions, rate limits per route
- [Storage and Adapter Wiring](/entity-system/storage-and-adapter-wiring/) — swap backends
- [Entity Backend Support](/reference/entity-backend-support/) — generated semantic support claims
- [Generated Routes, Overrides, and Extra Routes](/entity-system/generated-routes-overrides-and-extra-routes/) — customize the generated routes
