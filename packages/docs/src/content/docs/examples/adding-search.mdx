...
- [slingshot-search](/slingshot/packages/slingshot-search/) — full adapter and config reference
- [Config-Driven Domain](/slingshot/examples/config-driven-domain/) — defining entities with search operations
