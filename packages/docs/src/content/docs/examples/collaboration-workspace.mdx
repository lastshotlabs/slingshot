...
- [Forum App](/slingshot/examples/forum-app/) for the smaller community-only composition
- [Auth Setup](/slingshot/examples/with-auth/) for the identity baseline
- [slingshot-chat](/slingshot/packages/slingshot-chat/) for chat-specific config and route behavior
- [slingshot-assets](/slingshot/packages/slingshot-assets/) for storage, presigned URLs, and image serving
