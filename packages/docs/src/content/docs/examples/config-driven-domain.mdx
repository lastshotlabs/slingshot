...
- [Package-First Authoring](/package-first/) for the canonical package-level mental model
- [Entity System](/entity-system/) for the canonical entity authoring path
- [Entity System: Operations](/entity-system/operations/) for named behavior beyond CRUD
- [slingshot-entity](/packages/slingshot-entity/) for the full API surface
