...
- [Config-Driven](/config-driven/) for the higher-level mental model
- [Operations Reference](/config-driven/operations/) for every built-in operation kind
- [Config-Driven Walkthrough](/config-driven-walkthrough/) for a real community-oriented walkthrough
