...
The canonical authoring path uses `definePackage(...)` (via the `createXxxPackage(...)` factory
...
- [Package-First Authoring](/slingshot/package-first/) for the canonical package-level mental model
- [Entity System](/slingshot/entity-system/) for the canonical entity authoring path
- [Entity System: Operations](/slingshot/entity-system/operations/) for named behavior beyond CRUD
