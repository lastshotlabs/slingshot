...
- [SaaS Foundations](/examples/saas-foundations/) for the tenant and permissions story
- [runtime-edge package](/packages/runtime-edge/) for worker-host constraints
- [slingshot-ssr](/packages/slingshot-ssr/) for route loaders, draft mode, and ISR details
- [slingshot-ssg](/packages/slingshot-ssg/) for static collection and rendering behavior
