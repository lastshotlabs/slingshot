...
- [slingshot-auth](/packages/slingshot-auth/overview/) — full config reference with all options
- [Forum App](/examples/forum-app/) — add `slingshot-community` on top of auth
- [SaaS Foundations](/examples/saas-foundations/) — add organizations and per-resource permissions
- [OpenAPI](/guides/openapi/) — how `userAuth` and `requireRole` appear in the spec
