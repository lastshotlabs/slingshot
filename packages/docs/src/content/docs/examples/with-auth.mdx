...
> Experimental: `@lastshotlabs/slingshot-auth` is currently pre-1.0 (`0.0.2`) in this worktree.
> Read [Auth](/slingshot/core-features/auth/) and
> [Maturity and Package Status](/slingshot/core-features/maturity-and-package-status/) before you
> commit to this package in a product.
