...
[HookServices](/app-authoring/hook-services/) for the contract and the
...
- [Package docs](/packages/slingshot-mail/)
- [Content Platform example](/examples/content-platform/)
