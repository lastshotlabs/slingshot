...
- [Deployment](/guides/deployment/) — log driver config in `slingshot-infra`
- [Horizontal Scaling](/guides/horizontal-scaling/) — shared event bus for multi-instance
- [Secrets](/guides/secrets/) — securing the metrics endpoint token
- [slingshot-auth](/packages/slingshot-auth/) — full list of security event payloads
