---
title: 'Permissions: Setup and Patterns'
description: Plugin setup, grant patterns, resource lifecycle, and evaluation across routes and realtime
---

This is the operational companion to **[Authorization](/slingshot/core-features/permissions/)**
— the concept page covers the mental model (actor → grant → check); this page covers
plugin setup, grant lifecycle, and the patterns you reach for when wiring permissions
into a real app.
...
The permissions package is standalone by default — group expansion is disabled unless you
