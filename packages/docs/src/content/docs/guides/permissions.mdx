...
This is the operational companion to **[Authorization](/core-features/permissions/)**
...
- [Core Features: Permissions](/core-features/permissions/) — quick overview
- [Route Policy](/entity-system/route-policy/) — per-route auth and permission config
- [Auth](/core-features/auth/) — identity and sessions
- [SaaS Foundations](/examples/saas-foundations/) — auth + orgs + permissions end-to-end
