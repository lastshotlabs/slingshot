...
`onDeadLetter`. See [HookServices](/app-authoring/hook-services/) for
...
- [Package docs](/packages/slingshot-webhooks/) — full API reference
- [Events and the Event Bus](/app-authoring/events-and-the-event-bus/) — declaring deliverable events
- [Server-Sent Events](/app-authoring/server-sent-events/) — the other client-facing event transport
