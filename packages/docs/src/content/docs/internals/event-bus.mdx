...
- [Context and Registrar](/internals/context-registrar/) — where the bus lives in `SlingshotContext`
- [Plugin Lifecycle](/internals/plugin-lifecycle/) — `setupPost()` is where event subscriptions belong
