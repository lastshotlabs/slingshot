...
- [Context and Registrar](/slingshot/internals/context-registrar/) — how `StoreInfra` is provided
- [Reflect Symbol DI](/slingshot/internals/reflect-di/) — how entity registration flows through infra
