...
Current orchestration route setup is code-first: import middleware and pass it directly.

The future manifest path will resolve route middleware by export name from `slingshot.handlers.ts`,
