...
Define tasks and workflows in TypeScript, then compose
...
- `createServer()` loads `ResolvedTask` and `ResolvedWorkflow`
...
- [Orchestration Guide](/slingshot/orchestration/guide/)
