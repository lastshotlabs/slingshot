...
- [domain and route](/slingshot/package-first/domain-and-route/) — typed custom routes inside packages
- [Capabilities and entityRef](/slingshot/package-first/capabilities-and-entity-ref/) — cross-package contracts
