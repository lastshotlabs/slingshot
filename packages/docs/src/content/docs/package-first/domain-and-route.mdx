...
- [Capabilities and entityRef](/slingshot/package-first/capabilities-and-entity-ref/) — cross-package service contracts and entity access
...
- [Entity System](/slingshot/entity-system/) — when the route should be generated from a data model
