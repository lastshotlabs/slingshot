...
- [Plugin Interface](/authoring/plugin-interface/) — the canonical reference for `SlingshotPlugin` authoring
- [Package-First Authoring](/package-first/) — the parallel tier for app-side feature composition
...
- [Plugin Interface](/authoring/plugin-interface/) — full `SlingshotPlugin` reference
- [Package-First Authoring](/package-first/) — the parallel tier for app-side feature composition
