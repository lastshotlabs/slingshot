---
title: AI Draft
description: AI-assisted starting point for @lastshotlabs/slingshot-emoji
---
...
@lastshotlabs/slingshot-emoji is the feature package in the Slingshot workspace.
...
- Public exports: `.`
- API reference: /api/slingshot-emoji/
