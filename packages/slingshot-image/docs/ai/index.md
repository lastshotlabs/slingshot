---
title: AI Draft
description: AI-assisted starting point for @lastshotlabs/slingshot-image
---
...
@lastshotlabs/slingshot-image is the feature package in the Slingshot workspace.
...
- Public exports: `.`
- API reference: /api/slingshot-image/
