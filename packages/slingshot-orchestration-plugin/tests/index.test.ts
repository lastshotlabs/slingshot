...
describe('orchestration plugin public entrypoint', () => {
  test('exports the runtime integration surface', () => {
    expect(typeof orchestrationPlugin.createOrchestrationPackage).toBe('function');
    ...
    expect(orchestrationPlugin.ORCHESTRATION_PLUGIN_STATE_KEY).toBe('slingshot-orchestration-plugin');
  });
});
