// packages/slingshot-orchestration/tests/context-edge.test.ts
//
...
describe('ORCHESTRATION_PLUGIN_STATE_KEY', () => {
  test('is the string slingshot-orchestration', () => {
    expect(ORCHESTRATION_PLUGIN_STATE_KEY).toBe('slingshot-orchestration');
  });

  test('is exported from the package index', () => {
    expect(pluginIndex.ORCHESTRATION_PLUGIN_STATE_KEY).toBe('slingshot-orchestration');
  });
});
