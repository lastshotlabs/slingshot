---
title: AI Draft
description: AI-assisted starting point for @lastshotlabs/slingshot-runtime-lambda
---
...
@lastshotlabs/slingshot-runtime-lambda is the runtime package in the Slingshot workspace.

AWS Lambda runtime for Slingshot handlers
