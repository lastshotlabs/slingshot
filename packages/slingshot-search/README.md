...
- [Content Platform example](https://slingshot.lastshotlabs.com/examples/content-platform/) - search composed with assets, SSR, and edge runtime in `examples/content-platform/`
