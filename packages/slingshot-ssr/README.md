...
- [Content Platform example](https://slingshot.lastshotlabs.com/examples/content-platform/) - SSR, draft mode, metadata, and ISR-oriented composition in `examples/content-platform/`
