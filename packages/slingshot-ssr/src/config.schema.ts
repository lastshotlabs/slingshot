 ...
 * @internal
 */
export const ssrPluginConfigSchema = z
  .object({
    renderer: z
      .object({
        resolve: z
        ...
        render: z
          .function()
          .describe(
            'Renderer function that renders a resolved page into an HTTP response payload.',
          ),
    ...
    routeSource: z
      ...
      .optional()
      .describe('Pluggable route source. Overrides the default file-based discovery when set.'),
    assetsManifest: z
      .string()
     ...
     * `X-Draft-Mode-Secret` header or JSON request body against this value. When
  ...
  .refine(cfg => cfg.serverRoutesDir !== undefined || cfg.routeSource !== undefined, {
